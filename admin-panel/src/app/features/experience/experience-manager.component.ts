...
@Component({
          ...
          <form [formGroup]="expForm" (ngSubmit)="saveExperience()">
             <div class="form-row">
               <div class="form-group col">
                 ...
                 <input type="text" formControlName="role" class="form-control" placeholder="e.g. Senior Bridge Engineer">
               </div>
               <div class="form-group col">
                 <label>Company / Institution</label>
                 <input type="text" formControlName="company" class="form-control" placeholder="e.g. Engineering Corp">
               </div>
             </div>
             ...
             <div class="form-row">
               <div class="form-group col">
                 ...
                 <input type="text" formControlName="duration" class="form-control" placeholder="e.g. Jan 2021 - Present or 2018 - 2022">
               </div>
               <div class="form-group col">
                 <label>Location</label>
                 <input type="text" formControlName="location" class="form-control" placeholder="e.g. New York, USA">
               </div>
             </div>

             <div class="form-group">
               <label>Description</label>
               <textarea formControlName="description" class="form-control" rows="6" placeholder="Detail your project achievements and structural duties..."></textarea>
             </div>
  ...
  styles: [`
    ...
    .exp-info .date { font-size: 13px; color: #a0aec0; margin-right: 15px; }
    .exp-info .location { font-size: 13px; color: #a0aec0; }
